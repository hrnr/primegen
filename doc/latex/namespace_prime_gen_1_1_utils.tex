...
Computes logarithm with maximum precision avaible for standard types. {\ttfamily U\+Int\+Type} must be able to print itself to stream (ie. stream operator $<$$<$ must be defined)
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Result of $ ({base}^{exponent}) \% modulo $ 
\end{DoxyReturn}
